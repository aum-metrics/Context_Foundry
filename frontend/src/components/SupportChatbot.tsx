...
export default function SupportChatbot() {
    ...
    const generateBotResponse = (query: string) => {
        ...
        if (query.includes("onboard") || query.includes("add business") || query.includes("setup")) {
            response = `To onboard a new branch or sub-entity for ${orgName}, navigate to Organization Settings and provision a new Context Moat. Ensure your semantic manifest is ready for distillation.`;
            ...
            response = `I'm monitoring the Context Engine for ${orgName}. I can assist with Ingestion protocols, LCRS mathematical divergence, API Key isolation, or Security Audits.`;
        }
    ...
    return (
        ...
        {/* Input */ }
        < div className = "p-3 sm:p-4 border-t border-slate-200 dark:border-white/5 bg-white dark:bg-slate-900 shrink-0" >
