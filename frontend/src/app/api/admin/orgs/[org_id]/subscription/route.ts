...
export async function PATCH(request: NextRequest, context: { params: Promise<{ org_id: string }> }) {
    ...
    try {
        const resp = await fetch(`${BACKEND_URL}/api/admin/orgs/${org_id}/subscription`, {
            method: "PATCH",
            headers: {
